...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <center>
        <div style="padding-top: 1%; padding-bottom: 1%; background-color: tomato; color: white;">
            <h2>Total products amount :<%:carritoactual.TotalProductos.ToString() %></h2>
            <h2>Total price of your purchase : $<%:carritoactual.TotalPrecio.ToString() %></h2>
            <div>
                <asp:LinkButton ID="FinalizarCompra" runat="server" OnClick="FinalizarCompra_Click" CommandArgument='<%# Eval("articulo.codigo_a") %>' UseSubmitBehavior="false">
                           <a class="btn btn-warning text-light text-decoration-none" href="FinalizePurchase.aspx"><strong>Comprar</strong></a>
                </asp:LinkButton>
            </div>
